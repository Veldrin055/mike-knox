...
<nav class="top-0 select-none bg-purple-900 text-gray-100 lg:flex lg:items-stretch w-full z-20 shadow-lg fixed">
  <div class="flex flex-no-shrink items-stretch h-12">
    <router-link to="/" class="flex-no-grow flex-no-shrink relative py-2 px-4 text-lg leading-normal text-white md:font-extrabold flex items-center truncate">Mike Koclęga for Dobson Ward - Knox City</router-link>
